...
from application.init_pipeline import init_pipeline, get_numpy_features, get_tensor_features
...
def main():
    ...
    y_test = torch.tensor(y_test).double().unsqueeze(-1) # make sure y_test is a column vector
